...
Game.PlayGame.prototype = {
	...
	create : function(){
       ...
       // music.play('',0,1,true,false);
		...
		this.pausebutton = this.add.sprite(530,200,'pause');
	...
	update : function(){
		...
		switch(y){
			case 0 : 
				var pregunta = '¿Qué lamentaba Frankenstein para partir de Ingoltadt a estudiar?';
				...
				text = this.game.add.text(700, 50, pregunta , style);
			...
			case 1:
				...
				break;
			case 2:
				var pregunta = '¿Cual era el deseo de Caroline en su lecho de muerte?';
				var respuestaApregunta3 = "Que se casara Frankenstein con Elizabeth";
				var respuestaBpregunta3 = "Que volviera a Ingoltadt";
				var respuestaCpregunta3 = "Continuar sus estudios sobre la chisa de la vida";
				text = this.game.add.text(700, 50, pregunta , style);
